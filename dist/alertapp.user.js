...
`,x=!1;function U(n){x&&(document.getElementById("aa-root")?.remove(),document.getElementById("aa-style")?.remove(),x=!1),x=!0;let e=document.createElement("style");e.id="aa-style",e.textContent=ae,document.head.appendChild(e);let t=document.createElement("div");t.id="aa-root",document.body.appendChild(t);let r=document.createElement("button");r.className="aa-btn",r.setAttribute("aria-label","\uC54C\uB78C \uC704\uC82F \uC5F4\uAE30"),r.innerHTML='<span style="position:relative;display:inline-flex;align-items:center;justify-content:center">\u{1F514}<span class="aa-count" id="aa-count" style="display:none">0</span></span>',t.appendChild(r);let a=document.createElement("div");a.className="aa-panel",a.id="aa-panel",a.innerHTML=`
  ...
  `,t.appendChild(i);let s=null,c=!0;function u(o){let l=document.getElementById("aa-count");l&&(o>0?(l.textContent=String(o),l.style.display="block"):l.style.display="none")}function K(o){let l=document.getElementById("aa-alert-list");if(l){if(l.innerHTML="",o.length===0){l.innerHTML='<div class="aa-empty">\uC54C\uB78C \uC5C6\uC74C</div>';return}o.forEach(d=>{let p=document.createElement("div");p.className="aa-alert-item";let S=d.direction==="cross_above"?"\u2191 \uC704\uB85C cross":"\u2193 \uC544\uB798\uB85C cross",X=d.status==="armed"?"aa-badge-armed":d.status==="triggered"?"aa-badge-triggered":"aa-badge-paused",q=d.status==="armed"?"\uB300\uAE30":d.status==="triggered"?"\uBC1C\uD654":"\uC815\uC9C0";p.innerHTML=`
