...
"use strict";(()=>{var P={telegram:null,alerts:[]};var R="alertapp:settings";function W(){return typeof GM_getValue=="function"&&typeof GM_setValue=="function"}function Y(n){if(typeof window<"u")return window.__alertapp_storage__??={},window.__alertapp_storage__[n]}function Z(n,e){typeof window<"u"&&(window.__alertapp_storage__??={},window.__alertapp_storage__[n]=e)}async function Q(n){if(W()){let e=await GM_getValue(n,void 0);return typeof e=="string"?e:void 0}return Y(n)}async function ee(n,e){W()?await GM_setValue(n,e):Z(n,e)}async function g(){try{let n=await Q(R);return n?JSON.parse(n):{...P,alerts:[]}}catch{return{...P,alerts:[]}}}async function T(n){await ee(R,JSON.stringify(n))}async function O(n){let e=await g();e.alerts.push(n),await T(e)}async function N(n,e){let t=await g(),r=t.alerts.findIndex(a=>a.id===n);r!==-1&&(t.alerts[r]={...t.alerts[r],...e},await T(t))}async function D(n){let e=await g();e.alerts=e.alerts.filter(t=>t.id!==n),await T(e)}async function G(n){let e=await g();e.telegram=n,await T(e)}async function w(){return(await g()).telegram}var te="wss://stream.binance.com:9443/stream";var M=class{_url;_maxBackoffMs;_ws=null;_subscriptions=new Map;_reconnectAttempts=0;_reconnectTimer=null;_closed=!1;_msgIdCounter=1;constructor(e={}){this._url=e.url??te,this._maxBackoffMs=e.maxBackoffMs??3e4}get isConnected(){return this._ws?.readyState===WebSocket.OPEN}subscribe(e,t){let r=e.toLowerCase();this._subscriptions.has(r)||this._subscriptions.set(r,new Set),this._subscriptions.get(r).add(t),this._ws===null?this._connect():this._ws.readyState===WebSocket.OPEN&&this._sendSubscribe([r])}unsubscribe(e,t){let r=e.toLowerCase(),a=this._subscriptions.get(r);a&&(t!==void 0?a.delete(t):a.clear(),a.size===0&&(this._subscriptions.delete(r),this._sendUnsubscribe([r])))}close(){this._closed=!0,this._reconnectTimer!==null&&(clearTimeout(this._reconnectTimer),this._reconnectTimer=null),this._ws!==null&&(this._ws.onclose=null,this._ws.onerror=null,this._ws.close(),this._ws=null)}_connect(){if(this._closed)return;let e=new WebSocket(this._url);this._ws=e,e.onopen=()=>{this._reconnectAttempts=0;let t=Array.from(this._subscriptions.keys());t.length>0&&this._sendSubscribe(t)},e.onmessage=t=>{this._handleMessage(t.data)},e.onerror=()=>{},e.onclose=()=>{this._closed||(this._ws=null,this._scheduleReconnect())}}_scheduleReconnect(){if(this._closed)return;let e=Math.min(1e3*Math.pow(2,this._reconnectAttempts),this._maxBackoffMs);this._reconnectAttempts++,this._reconnectTimer=setTimeout(()=>{this._reconnectTimer=null,this._closed||this._connect()},e)}_handleMessage(e){let t;try{t=JSON.parse(e)}catch{return}if(!ne(t))return;let a=t.stream.split("@")[0];if(!a)return;let o=this._subscriptions.get(a);if(!o||o.size===0)return;let s=parseFloat(t.data.p);if(!isFinite(s))return;let p={symbol:a.toUpperCase(),price:s,ts:Math.floor(t.data.T/1e3)};for(let c of o)c(p)}_sendSubscribe(e){this._sendJson({method:"SUBSCRIBE",params:e.map(t=>`${t}@trade`),id:this._msgIdCounter++})}_sendUnsubscribe(e){this._sendJson({method:"UNSUBSCRIBE",params:e.map(t=>`${t}@trade`),id:this._msgIdCounter++})}_sendJson(e){this._ws?.readyState===WebSocket.OPEN&&this._ws.send(JSON.stringify(e))}};function ne(n){if(typeof n!="object"||n===null)return!1;let e=n;if(typeof e.stream!="string"||typeof e.data!="object"||e.data===null)return!1;let t=e.data;return!(typeof t.p!="string"||typeof t.T!="number")}function H(n){return new M(n)}var $=typeof unsafeWindow<"u"?unsafeWindow:window,z=new Set(["LineToolTrendLine","LineToolRay","LineToolExtended","LineToolArrow","LineToolTrendAngle","LineToolDisjointAngle","LineToolParallelChannel","LineToolPolyline"]);function x(){try{return $._exposed_chartWidgetCollection?.activeChartWidget?.value?.()??null}catch{return null}}function _(n){let e=n.time_t??n.time??0;e>1e12&&(e=Math.floor(e/1e3));let t=n.price??n.value??0;return{time:e,price:t}}function F(n=3e4){return new Promise((e,t)=>{let a=Date.now()+n,o=setInterval(()=>{try{let s=x();if(s&&typeof s.lineToolsAndGroupsDTO=="function"){clearInterval(o),e(s);return}}catch{}Date.now()>=a&&(clearInterval(o),t(new Error(`alertapp: waitForTvChart timed out after ${n}ms`)))},250)})}function k(){let n=b().raw;try{let e=x();if(e&&typeof e.lineToolsAndGroupsDTO=="function"){let t=e.lineToolsAndGroupsDTO(),r=[];return t.forEach(a=>{a.sources.forEach((o,s)=>{let p=o.state??o,c=p?.type??o.type;if(!c||!z.has(c))return;let m=p?.points??o.points;if(!m||m.length<2)return;let v=o.state?.state?.symbol??n;r.push({id:s,p1:_(m[0]),p2:_(m[1]),symbol:v})})}),console.info("[alertapp] readAllTrendlines v2 path: \uBC1C\uACAC line type =",[...t.values()].flatMap(a=>[...a.sources.values()].map(o=>o?.state?.type??o.type))),r}}catch(e){console.warn("[alertapp] lineToolsAndGroupsDTO \uC2E4\uD328 \u2014 \uD6C4\uBCF4 2 \uC2DC\uB3C4",e)}try{let t=x()?.model?.();if(!t)return[];let r=[];return t.panes().forEach(a=>{a.dataSources().forEach(o=>{let s=o.constructor?.name??"",p=o.toolname??s;if(!z.has(p))return;let c=typeof o.points=="function"?o.points():o.points??o._points??[];!c||c.length<2||r.push({id:o.id??`fb-${Math.random()}`,p1:_(c[0]),p2:_(c[1]),symbol:n})})}),r}catch(e){return console.warn("alertapp: \uD6C4\uBCF4 2 dataSources fallback \uB3C4 \uC2E4\uD328. TV API \uBCC0\uACBD \uAC00\uB2A5\uC131.",e),[]}}function b(){try{let e=$._exposed_chartWidgetCollection?.activeChartWidget?.value?.(),t;return typeof e?.symbol=="function"?t=e.symbol():typeof e?.activeChartSymbolInfo=="function"&&(t=e.activeChartSymbolInfo()?.name),t?{raw:t,binanceSymbol:re(t)}:{raw:"",binanceSymbol:null}}catch(n){return console.warn("alertapp: readCurrentSymbol \uC2E4\uD328",n),{raw:"",binanceSymbol:null}}}function re(n){let e=/^BINANCE:([A-Z0-9]+)(\.P)?$/.exec(n);return!e||e[2]===".P"?null:e[1]}function U(n){let e=b().raw,t=!1,r=[];try{let s=x()?.model?.();s&&s.panes().forEach(p=>{p.dataSourcesCollectionChanged&&p.dataSourcesCollectionChanged.subscribe(null,()=>{let c=b();c.raw!==e&&(e=c.raw,n(c))})})}catch{}let a=setInterval(()=>{if(!t)try{let o=b();o.raw!==e&&(e=o.raw,n(o))}catch{}},300);return()=>{t=!0,clearInterval(a),r.forEach(o=>o())}}var ae=`
.aa-btn {
  position: fixed;
  right: 16px;
  top: 80px;
